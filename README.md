...
| `Dockerfile.ubi8-openssl-fips` | `registry.access.redhat.com/ubi8` | Go toolchain built from [golang-fips/go](https://github.com/golang-fips/go) for FIPS/OpenSSL support | `ubi8-openssl-fips-latest`, `ubi8-openssl-fips-v1.22` |
| `Dockerfile.ubi9-openssl-fips` | `registry.access.redhat.com/ubi9` | Go toolchain built from [golang-fips/go](https://github.com/golang-fips/go) for FIPS/OpenSSL support | `ubi9-openssl-fips-latest`, `ubi9-openssl-fips-v1.22` |
| `Dockerfile.ubi10-openssl-fips` | `registry.access.redhat.com/ubi10` | Go toolchain built from [golang-fips/go](https://github.com/golang-fips/go) for FIPS/OpenSSL support | `ubi10-openssl-fips-latest`, `ubi10-openssl-fips-v1.22` |
